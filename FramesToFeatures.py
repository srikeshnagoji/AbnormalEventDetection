...
def framesToFeatures(root,pattern): # root='/Users/srikeshnagoji/Desktop/myversion/frames/',pattern = "*.tif"
	...
	print "Number of Frames imported : ",numOfFiles
...
def show_image(folder,file_list_no,pattern="*.tif"): #displaying the abnormal images set
